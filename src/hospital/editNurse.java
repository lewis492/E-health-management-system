...
public class editNurse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Nurses Records");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String dgender= dn.getText();
        String dname= ds.getText();
        try{ Class.forName("com.mysql.jdbc.Driver");
            Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/hms","root","");

            String sql = "update `nurse_record` SET `NurseName`='"+dname+"',`gender`='"+dgender+"'WHERE nurse_id='"+did+"'";
